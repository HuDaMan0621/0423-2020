...
function getCardPic(card)
{
    ...
    // console.log('/Users/hudaman/Desktop/Projects/0423-2020/Pm/image/' + cardName + cardSuit + '.jpg');
...
dealBtn.addEventListener('click', function () {
    ...
    // const card2 = document.createElement('img'); //created the holder
    // const card3 = document.createElement('img'); //created the holder
    // const card4 = document.createElement('img');
    // if (card.point === 1){
    //     //image = Ace of something
    // }

    // card.setAttribute('src', './image/2C.jpg');
    // card2.setAttribute('src', './image/Red_back.jpg');//set the card image to from the location

    // card3.setAttribute('src', './image/10D.jpg');
    // card4.setAttribute('src', './image/AC.jpg');

    // dealerHand.append(card);
    // dealerHand.append(card2);

    // playerHand.append(card3);
    // playerHand.append(cardPicture);
    // dealerHand.append(cardPicture);

    // card.setAttribute('src', cardPicture);
